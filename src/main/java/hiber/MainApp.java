...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      userService.addCar(new Car("Tesla", 3));
      userService.addCar(new Car("Subaru", 8));
      userService.addCar(new Car("BMW", 7));
      userService.addCar(new Car("Mazda", 3));
      ...
      System.out.println(userService.getCarOwner("Tesla", 3));
